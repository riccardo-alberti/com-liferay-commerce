...
import com.liferay.commerce.price.list.service.CommercePriceListRelService;
...
/**
 * Provides the base implementation for the commerce price list rel remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.commerce.price.list.service.impl.CommercePriceListRelServiceImpl}.
 * </p>
 *
 * @author Alessio Antonio Rendina
 * @see com.liferay.commerce.price.list.service.impl.CommercePriceListRelServiceImpl
 * @generated
 */
public abstract class CommercePriceListRelServiceBaseImpl
	extends BaseServiceImpl
	implements CommercePriceListRelService, IdentifiableOSGiService {

	/**
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CommercePriceListRelService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.liferay.commerce.price.list.service.CommercePriceListRelServiceUtil</code>.
	 */
	 ...
	 */
	public CommercePriceListRelService getCommercePriceListRelService() {
	...
	public String getOSGiServiceIdentifier() {
		return CommercePriceListRelService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				commercePriceListRelPersistence.getDataSource();
	...
	@BeanReference(
		type = com.liferay.commerce.price.list.service.CommercePriceListContractRelService.class
	)
	protected
		com.liferay.commerce.price.list.service.
			CommercePriceListContractRelService
	...
	@BeanReference(type = CommercePriceListRelService.class)
	protected CommercePriceListRelService commercePriceListRelService;
