...
public interface CommercePriceModifierLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CommercePriceModifierLocalServiceUtil} to access the commerce price modifier local service. Add custom service methods to <code>com.liferay.commerce.price.modifier.service.impl.CommercePriceModifierLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never reference this class directly. Use <code>CommercePriceModifierLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>CommercePriceModifierLocalServiceUtil</code>.
	 */
	@Indexable(type = IndexableType.REINDEX)
	public CommercePriceModifier addCommercePriceModifier(
