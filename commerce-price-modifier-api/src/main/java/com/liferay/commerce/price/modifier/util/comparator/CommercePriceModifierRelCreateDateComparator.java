 ...
 */
public class CommercePriceModifierRelCreateDateComparator
	extends OrderByComparator<CommercePriceModifierRel> {
	...
	public CommercePriceModifierRelCreateDateComparator() {
		this(false);
	}

	public CommercePriceModifierRelCreateDateComparator(boolean ascending) {
