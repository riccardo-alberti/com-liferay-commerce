...
import com.liferay.commerce.price.modifier.internal.type.comparator.CommercePriceModifierTypeOrderComparator;
 ...
 */
@Component(immediate = true, service = CommercePriceModifierTypeRegistry.class)
