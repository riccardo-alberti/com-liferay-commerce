...
/**
 * Provides the remote service utility for CommercePriceListContractRel. This utility wraps
 * <code>com.liferay.commerce.price.list.service.impl.CommercePriceListContractRelServiceImpl</code> and is an
 ...
 * @generated
 */
public class CommercePriceListContractRelServiceUtil {

	/**
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.commerce.price.list.service.impl.CommercePriceListContractRelServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static void deleteCommercePriceListContractRel(
		...
		getService().deleteCommercePriceListContractRel(
	...
	public static CommercePriceListContractRelService getService() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker
		<CommercePriceListContractRelService,
		 CommercePriceListContractRelService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(
			CommercePriceListContractRelService.class);

		ServiceTracker
			<CommercePriceListContractRelService,
			 CommercePriceListContractRelService> serviceTracker =
				new ServiceTracker
					<CommercePriceListContractRelService,
					 CommercePriceListContractRelService>(
						 bundle.getBundleContext(),
						 CommercePriceListContractRelService.class, null);
