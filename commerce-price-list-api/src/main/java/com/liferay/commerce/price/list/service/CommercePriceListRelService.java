...
/**
 * Provides the remote service interface for CommercePriceListRel. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author Alessio Antonio Rendina
 * @see CommercePriceListRelServiceUtil
 * @generated
 */
@AccessControlled
@JSONWebService
@OSGiBeanProperties(
	property = {
		...
		"json.web.service.context.path=CommercePriceListRel"
	},
	service = CommercePriceListRelService.class
)
@ProviderType
@Transactional(
...
public interface CommercePriceListRelService extends BaseService {
