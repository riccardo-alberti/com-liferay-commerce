...
/**
 * The extended model interface for the CommercePriceListRel service. Represents a row in the &quot;CommercePriceListRel&quot; database table, with each column mapped to a property of this class.
 *
 * @author Alessio Antonio Rendina
 * @see CommercePriceListRelModel
 * @generated
 */
@ImplementationClassName(
	"com.liferay.commerce.price.list.model.impl.CommercePriceListRelImpl"
)
@ProviderType
public interface CommercePriceListRel
	extends CommercePriceListRelModel, PersistedModel {
	...
	public static final Accessor<CommercePriceListRel, Long>
		COMMERCE_PRICE_LIST_REL_ID_ACCESSOR =
			new Accessor<CommercePriceListRel, Long>() {
				...
				@Override
				public Class<CommercePriceListRel> getTypeClass() {
