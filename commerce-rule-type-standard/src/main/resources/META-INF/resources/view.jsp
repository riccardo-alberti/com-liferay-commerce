...
<%
	AddedAllCommerceRuleDisplayContext addedAllCommerceDiscountRuleDisplayContext = (AddedAllCommerceRuleDisplayContext)request.getAttribute("view.jsp-addedAllCommerceDiscountRuleDisplayContext");
