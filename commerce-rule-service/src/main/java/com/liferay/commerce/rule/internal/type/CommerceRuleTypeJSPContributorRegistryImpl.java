 ...
 */
@Component(
	immediate = true, service = CommerceRuleTypeJSPContributorRegistry.class
)
public class CommerceRuleTypeJSPContributorRegistryImpl
	...
	public List<CommerceRuleTypeJSPContributor>
		...
		List<CommerceRuleTypeJSPContributor> commerceRuleTypeJSPContributors =
			new ArrayList<>();
		...
		return Collections.unmodifiableList(commerceRuleTypeJSPContributors);
	}
